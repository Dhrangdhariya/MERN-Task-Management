...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0B0F19] bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-teal-900/20 via-[#0B0F19] to-purple-950/20 flex items-center justify-center px-4 relative overflow-hidden">

            {/* Ambient background glow shapes for that exclusive depth */}
            ...
            <div className="w-full max-w-md bg-[#151D30]/50 backdrop-blur-xl border border-slate-800 rounded-3xl shadow-2xl p-8 md:p-10 relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Exclusive Gradient Button with hover lifting effect */}
                    <button
                        type="submit"
